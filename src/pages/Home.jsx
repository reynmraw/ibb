...
import { Container, Col, Row, Image, Form, Button, Nav } from "react-bootstrap";
  ...
  return (
    <>
          ...
          <Row>
            <Col>
              ...
              <p>
                ...
                experiences of running own retail stores. Typically, retail
                store will buy products from their supplier based on what they
                need and what their customer's need. They do not get any further
                support to build their business. The support like price policy,
                branding and promotional activities, optimum margin, after sales
                services and warranties are actually essentials for these retail
                stores to grow their business. With this background experiences,
                IBB is born to be their best friend.
              </p>
            </Col>
            <Col>
          ...
          <Row>
            <div className="DealerPartner">
              <div className="DealerPartnerContent">
                ...
                <p className="TotalDealersCountIndonesia">
      ...
      >
        ...
        <div className="my-3 mx-5 px-5 p-3">
          <Row>
          ...
          <Row>
            ...
            <Col className="col-1">
              <img src={fb} className="logoHome" alt="facebook" />
            </Col>
            <Col className="col-1">
              <img src={ig} className="logoHome" alt="facebook" />
            </Col>
            <Col className="col-1">
              <img src={yt} className="logoHome" alt="facebook" />
            </Col>
          </Row>
        </div>
      </Container>
